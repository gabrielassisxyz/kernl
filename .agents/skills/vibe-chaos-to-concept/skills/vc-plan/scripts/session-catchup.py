#!/usr/bin/env python3
"""
Session Catchup Script for vc-plan
...
PLANNING_FILES = ['task_plan.md', 'findings.md']
...
def main():
    ...
    # Check docs/ first, then fall back to project root for legacy paths
    docs_path = Path(project_path, "docs")
    has_planning_files = any(
        Path(docs_path, f).exists() for f in PLANNING_FILES
    ) or any(
    ...
    print("\n[vc-plan] SESSION CATCHUP DETECTED")
    ...
    print("2. Read: task_plan.md, findings.md")
