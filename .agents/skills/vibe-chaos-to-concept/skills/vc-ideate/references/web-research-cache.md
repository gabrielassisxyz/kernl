...
Files live under `<scratch-dir>/web-research-cache.json`, where `<scratch-dir>` is `/tmp/vibe-chaos-to-concept/vc-ideate/<run-id>`, resolved once in SKILL.md Phase 1.
...
```bash
SCRATCH_ROOT="/tmp/vibe-chaos-to-concept/vc-ideate"
